...
pomp::bake("data/peopleNoVax.RDS",{
  ...
  for(i in 1:17){
    ...
    peopleNoVax[[i]][sample(which(peopleNoVax[[i]]$ltbi==1 & peopleNoVax[[i]]$ageAtTB==0),size=round(Nltbi*0.1)),atbi:=1]
  }
  peopleNoVax
}) -> peopleNoVax
...
pomp::bake("data/peopleWithVax.RDS",{
  ...
  for(i in 1:17){
    ...
    peopleWithVax[[i]][sample(which(peopleWithVax[[i]]$ltbi==1 & peopleWithVax[[i]]$ageAtTB==0),size=round(Nltbi*0.1)),atbi:=1]
  }
  peopleWithVax
}) -> peopleWithVax
```
